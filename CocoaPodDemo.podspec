...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "engleliu" => "engleliu@tencent.com" }
  # Or just: spec.author    = "engleliu"
  # spec.authors            = { "engleliu" => "engleliu@tencent.com" }
  # spec.social_media_url   = "https://twitter.com/engleliu"
